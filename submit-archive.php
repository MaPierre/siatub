...
if(isset($_GET['id']) && $_GET['id'] > 0){
    ...
    if(isset($student_id)){
        if($student_id != $_settings->userdata('id')){
            echo "<script> alert('Vous n'avez pas accès à cette page'); location.replace('./'); </script>";
        }
    }
}
?>
...
<div class="content py-4">
    <div class="card card-outline card-primary shadow rounded-0">
        <div class="card-header rounded-0">
            <h5 class="card-title"><?= isset($id) ? "Update Archive-{$archive_code} Détails" : "Soumettre le projet" ?></h5>
        </div>
            ...
            <div class="container-fluid">
                <form action="" id="archive-form">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="title" class="control-label text-navy">Titre du projet</label>
                                <input type="text" name="title" id="title" autofocus placeholder="Titre du projet" class="form-control form-control-border" value="<?= isset($title) ?$title : "" ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="abstract" class="control-label text-navy">Résumé</label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="img" class="control-label text-muted">Image du projet/Image de la bannière</label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="pdf" class="control-label text-muted">Document de projet (fichier PDF uniquement)</label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group text-center">
                                <button class="btn btn-default bg-navy btn-flat">Enregistrer</button>
...
<head>
    ...
    <title>Soumettre une thèse</title>
</head>
<body>
