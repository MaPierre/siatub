            ...
            <div class="container-fluid">
                <form action="" id="archive-form">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" autofocus placeholder="Titre du projet"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea rows="3" name="members" id="members" placeholder="membres"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="img" class="control-label text-muted">Image du projet/Image de la
                                    bannière</label>
                            ...
                            <div class="form-group text-center">
                                <img src="<?= validate_image(isset($banner_path) ? $banner_path : "") ?>"
                                    alt="La bannière du projet" id="cimg"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="pdf" class="control-label text-muted">Document de projet (fichier PDF
                                    uniquement)</label>
