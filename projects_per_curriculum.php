    ...
    <div class="col-12">
        <div class="card card-outline card-primary shadow rounded-0">
            <div class="card-body rounded-0">
                <center>
                    <h2>Liste d'archives de thèmes de mémoire pour la filière de
                        <?= isset($curriculum['name']) ? $curriculum['name'] : "" ?> </h2>
                </center>
                <center>
                    <p><mark><small><?= isset($curriculum['description']) ? $curriculum['description'] : "" ?></small></mark>
                    </p>
                </center>
                <hr class="bg-navy">
                <?php 
            ...
            <div class="card-footer clearfix rounded-0">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-6"><span class="text-muted">Affichage des thèmes:
