...
<h1>Nos forfaits de formation</h1>
...
<div class="container-fluid">
    ...
    <?php if($package->num_rows < 1): ?>
        <center><span class="text-muted">Aucun paquet répertorié pour le moment.</span></center>
    <?php endif; ?>
        <div id="no_result" style="display:none"><center><span class="text-muted">Aucun paquet répertorié pour le moment.</span></center></div>
    </div>
</div>
<script>
    $(function(){
