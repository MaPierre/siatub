    ...
    <div class="col-12">
        <div class="card card-outline card-primary shadow rounded-0">
            <div class="card-body rounded-0">
                <center>
                    <h2>Liste d'archives des thèmes de mémoire</h2>
                </center>
                <hr class="bg-navy">
                <?php 
                $limit = 10;
                ...
                <h3 class="text-center"><b>Résultat(s) de la recherche pour "<mark><?= $keyword ?></mark>"comme
                        mot-clé</b></h3>
                <?php endif ?>
            ...
            <div class="card-footer clearfix rounded-0">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-6"><span class="text-muted">Nombre de thèses:
                                <?= $archives->num_rows ?></span></div>
                        <div class="col-md-6">
                            <ul class="pagination pagination-sm m-0 float-right">
                                <li class="page-item"><a class="page-link"
                                        href="./?page=projects<?= $isSearch ?>&p=<?= $page - 1 ?>"
