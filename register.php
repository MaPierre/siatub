                ...
                <div class="card-body">
                    ...
                    <form action="" id="registration-form">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input type="text" name="firstname" id="firstname" autofocus placeholder="Prénom" class="form-control form-control-border" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input type="text" name="middlename" id="middlename" placeholder="Surnom (optionnel)" class="form-control form-control-border">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input type="text" name="lastname" id="lastname" placeholder="Nom" class="form-control form-control-border" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="curriculum_id" id="curriculum_id" class="form-control form-control-border select2" required>
                                        <option value="" disabled selected >--Sélectionnez le département d'abord--</option>
                                        <?php 
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="password" name="password" id="password" placeholder="Mot de passe" class="form-control form-control-border" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="password" id="cpassword" placeholder="Confirmer le mot passe" class="form-control form-control-border" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<script>
  var cur_arr = $.parseJSON('<?= json_encode($cur_arr) ?>'); // CETTE LIGNE A DES ERREURS IL FAUT VOIR COMMENT LA CORRIGER POUR AFFICHER LE FORMULAIRE D'INSCRIPTION
  $(document).ready(function()
  {
    ...
    $('#registration-form').submit(function(e){
        ...
        $.ajax({
            ...
            error:err=>{
                console.log(err)
                el.text("adresse email déjà prise,veuillez réessayer une autre adresse email")
                el.addClass("alert-danger")
                _this.prepend(el)
                el.show('slow')
                end_loader()
