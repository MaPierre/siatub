...
<footer class="main-footer text-sm">
  <div class="container">
        <strong>Tous droits réservés &copy; <?php echo date('Y') ?>. 
        <!-- <a href=""></a> -->
        </strong>
       <div class="float-right d-none d-sm-inline-block">
          <b><?php echo $_settings->info('short_name') ?> Par: <a href="mailto:irakozepierre2@gmail.com" target="blank">Pierre M</a> </b>
        </div>
      </div>
      </footer>
    </div>
...
<div id="libraries">
    ...
    <div class="daterangepicker ltr show-ranges opensright">
      <div class="ranges">
        <ul>
          ...
          <li data-range-key="Last 30 Days">30 derniers jours</li>
          <li data-range-key="This Month">Ce Mois</li>
          <li data-range-key="Last Month">Dernier Mois</li>
          <li data-range-key="Custom Range">Intervalle personnalisée</li>
        </ul>
      </div>
    ...
    <div class="jqvmap-label" style="display: none; left: 1093.83px; top: 394.361px;">SATUB</div>
<script>
  $(function(){
