                ...
                <div class="container-fluid">
                    ...
                    <div class="form-group">
                        <a href="./?page=submit-archive&id=<?= isset($id) ? $id : "" ?>"
                            class="btn btn-flat btn-default bg-navy btn-sm"><i class="fa fa-edit"></i> Editer</a>
                        <button type="button" data-id="<?= isset($id) ? $id : "" ?>"
                            class="btn btn-flat btn-danger btn-sm delete-data"><i
                    ...
                    <center>
                        <img src="<?= validate_image(isset($banner_path) ? $banner_path : "") ?>"
                            alt="Image de bannière" id="banner-img" class="img-fluid border bg-gradient-dark">
                    </center>
                    <fieldset>
                    ...
                    <fieldset>
                        <legend class="text-navy">Cote:</legend>
                        <div class="pl-4">
                            <large><?= isset($cote) ? html_entity_decode($cote) : "" ?></large>
                        </div>
                    </fieldset>
                    <fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="pl-4">
                            <iframe
                                src="<?= isset($document_path) ? base_url.$document_path : "" ?>#toolbar=0&navpanes=1"
                                width="100%" height="300" frameborder="0" id="document_field"
                                class="text-center w-100">Chargement du document
                                ...</iframe>
                        </div>
                    </fieldset>
                </div>
...
$(function() {
    $('.delete-data').click(function() {
        _conf("Êtes-vous sûr de vouloir supprimer <b>Archive-<?= isset($archive_code) ? $archive_code : "" ?></b>",
            "delete_archive")
    })
})
