...
(function (h) {
  ...
  function Ea(a) {
    ...
    if (a) {
      ...
      !a.sEmptyTable &&
        d &&
        "aucune donnée disponible" === b.sEmptyTable &&
      ...
      if (0 !== i.length) {
        ...
        for (j = j ? 0 : g; j < f; j++) {
          ...
          if (0 !== e) {
            var G = d[c % e];
            q._sRowStripe != G &&
              (h(r).removeClass(q._sRowStripe).addClass(G),
              (q._sRowStripe = G));
          }
      ...
      for (j = m.length; g < j; g++) {
        ...
        if (b === "table") {
          ...
          for (h = o.length; i < h; i++) {
            ...
            f =
              b === "cell"
                ? c.call(u, m[g], f.row, f.column, g, i)
                : c.call(u, m[g], f, g, i, l);
            f !== k && e.push(f);
          }
        }
      }
  ...
  l.defaults = {
    ...
    oLanguage: {
      ...
      sInfoEmpty: "Affichage 0 à 0 sur 0 entrées",
      sInfoFiltered: "(filtré à partir de _MAX_ entrées au total)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "Affichage  _MENU_ entrées",
      sLoadingRecords: "Loading...",
      sProcessing: "Processing...",
      sSearch: "Recherche:",
      sSearchPlaceholder: "Entrer un mot clé",
      sUrl: "",
