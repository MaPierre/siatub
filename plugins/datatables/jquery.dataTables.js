...
(function (factory) {
  ...
  DataTable.defaults = {
    ...
    oLanguage: {
       ...
       *
       *  @type string
       *  @default Affichade _START_ à _END_ sur _TOTAL_ entries
       *
       *  @dtopt Language
       ...
       *    } );
       */
      sInfo: "Affichage _START_ à _END_ sur _TOTAL_ entrées",
       ...
       *    } );
       */
      sZeroRecords: "Aucun enregistrement correspondants trouvé",
    },
