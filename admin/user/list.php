...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="?page=user/manage_user" class="btn btn-flat btn-success"><span class="fa fa-user-plus"></span>
                ...
                <table class="table table-hover table-striped">
					...
					?>
                        <tr>
                            ...
                            <td>
                                <p class="m-0"><?php echo ($row['type'] == 1 )? "Adminstrateur" : "Staff" ?></p>
                            </td>
                            <td align="center">
                                <button type="button"
                                ...
                                <div class="dropdown-menu" role="menu">
                                    <a class="dropdown-item"
                                        href="?page=user/manage_user&id=<?php echo $row['id'] ?>"><span
                                            class="fa fa-edit text-primary"></span> Editer</a>
...
$(document).ready(function() {
    $('.delete_data').click(function() {
        _conf("Vous voulez effacer cet utilisateur défitivement?", "delete_user", [$(this).attr(
            'data-id')])
    })
    $('.table td,.table th').addClass('py-1 px-2 align-middle')
    $('.table').dataTable();
    $('.verify_user').click(function() {
        _conf("Vous voulez vérifier le compte de cet utilisateur <b>" + $(this).attr('data-name') +
            "<b/>?", "verify_user", [$(this).attr('data-id')])
    })
})
