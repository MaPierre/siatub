                ...
                <table class="table table-hover table-striped">
					...
					?>
                        <tr>
                            ...
                            <td align="center">
                                <button type="button"
                                    class="btn btn-flat btn-danger btn-sm dropdown-toggle dropdown-icon"
...
$(document).ready(function() {
    ...
    $('.delete_data').click(function() {
        _conf("Êtes-vous sûr de supprimer définitivement ce programme d'études?", "delete_curriculum", [
            $(this).attr('data-id')
        ])
    })
