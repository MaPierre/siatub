...
$(document).ready(function() {
    ...
    $('.edit_data').click(function() {
        uni_modal("Modifier les Détails du département", "departments/manage_department.php?id=" + $(
            this).attr('data-id'))
    })
    $('.delete_data').click(function() {
        _conf("Êtes-vous sûr de supprimer définitivement ce département ?", "delete_department", [$(
            this).attr('data-id')])
    })
    $('.view_data').click(function() {
        uni_modal("Détails du département", "departments/view_department.php?id=" + $(this).attr(
            'data-id'))
    })
