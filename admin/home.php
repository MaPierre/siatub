...
<div class="row">
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-primary bg-gradient shadow">
            <span class="info-box-icon bg-danger bg-gradient elevation-1"><i class='fas fa-scroll fa-spin fa-1x'  style='color:green'></i></span>
            <div class="info-box-content">
            <span class="info-box-text">Domaines d'études</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-info shadow">
            <span class="info-box-icon bg-primary elevation-1"><i class="fa fa-graduation-cap" aria-hidden="true"></i></span>
