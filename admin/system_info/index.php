...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title">Informations du Système </h5>
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="name" class="control-label">Nom du Système</label>
				<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
			</div>
			<div class="form-group">
				<label for="short_name" class="control-label">Nom du Système en sigle</label>
				<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
			</div>
			<div class="form-group">
				<label for="content[about_us]" class="control-label">Contenu de Bienvenu</label>
			...
			<div class="form-group">
				<label for="content[about_us]" class="control-label">A propos de nous</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Logo du système</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Photo de couverture</label>
				<div class="custom-file">
			...
			<fieldset>
				<legend>Information d'établissement</legend>
				<div class="form-group">
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="system-frm">Mettre à jour</button>
				</div>
			</div>
		</div>
