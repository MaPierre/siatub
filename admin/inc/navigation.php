...
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand bg-dark bg-gradient">
    ...
    <a href="<?php echo base_url ?>admin" class="brand-link bg-transparent text-sm shadow-sm">
        <img src="<?php echo validate_image($_settings->info('logo'))?>" alt="Logo Système"
            class="brand-image img-circle elevation-3 bg-black"
            style="width: 3rem;height: 3rem;max-height: unset;object-fit:scale-down;object-position:center center">
                ...
                <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                    ...
                    <nav class="mt-4">
                        <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child"
                            ...
                            <li class="nav-item dropdown">
                                <a href="<?php echo base_url ?>admin/?page=departments"
                                    class="nav-link nav-departments">
                            ...
                            <li class="nav-item dropdown">
                                <a href="<?php echo base_url ?>admin/?page=membres" class="nav-link ">
...
$(document).ready(function() {
    ...
    $('#receive-nav').click(function() {
        ...
        uni_modal("Entrez le numéro de suivi", "transaction/find_transaction.php");
    })
})
</script>