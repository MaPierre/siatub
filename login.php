...
<div class="h-100 d-flex  align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100 h-100">
        ...
        <h1 style="text-align:center;color:white;text-shadow: 2px 2px 8px #FF0000;"><b><?php echo $_settings->info('short_name') ?> - Etudiants</b></h1>
      </div>
    ...
    <div class="col-5 h-100 bg-gradient bg-navy">
        <div class="w-100 d-flex justify-content-center align-items-center h-100 text-navy">
            <div class="card card-outline card-primary rounded-0 shadow col-lg-10 col-md-10 col-sm-5">
                ...
                <div class="card-body">
                    <form action="" id="slogin-form" autocomplete="on">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="email" name="email" id="email" placeholder="Email" class="form-control form-control-border" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="password" name="password" id="password" placeholder="Mot de passe" class="form-control form-control-border" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="col-lg-12"> <button class="btn btn-secondary btn-block"><a href="index.php"> Retour</a></button>
                              </div>
                        </div>
                    </form>
                </div>
