      ...
      success: function (resp) {
        if (resp) {
          ...
          if (resp.status == "success") {
            ...
            var _frm = $("#login-frm");
            var _msg =
              "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> Nom d'utilisateur ou mot de passe incorrect</div>";
            _frm.prepend(_msg);
            ...
            var _frm = $("#login-frm");
            var _msg =
              "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> Votre compte n'est pas encore vérifié,essayez plus tard.</div>";
            _frm.prepend(_msg);
            _frm.find("input").addClass("is-invalid");
            $('[name="username"]').focus();
          }
